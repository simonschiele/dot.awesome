...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "s", function () obvious.popup_ssh_prompt.run_prompt() end),
    awful.key({ modkey }, "e", function () if use_obvious_widgets then obvious.popup_run_prompt.run_prompt() else mypromptbox[mouse.screen]:run() end end),
...
for s = 1, screen.count() do
   keynumber = math.min(7, math.max(#tags[s], keynumber));
end
