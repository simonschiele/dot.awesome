...
function run_prompt()
    ...
    awful.prompt.run({ prompt = settings.prompt_string },
        ...
        function (host) awful.util.spawn("gnome-terminal -x ssh -v " .. host, false) end,
