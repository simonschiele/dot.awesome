...
-- IMAGES
theme.layout_fairh           = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/fairh.png"
theme.layout_fairv           = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/fairv.png"
theme.layout_floating        = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/floating.png"
theme.layout_magnifier       = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/magnifier.png"
theme.layout_max             = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/max.png"
theme.layout_fullscreen      = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/fullscreen.png"
theme.layout_tilebottom      = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/tilebottom.png"
theme.layout_tileleft        = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/tileleft.png"
theme.layout_tile            = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/tile.png"
theme.layout_tiletop         = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/tiletop.png"

theme.awesome_icon           = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/awesome-icon.png"
theme.tasklist_floating_icon = os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/layouts/floating.png"
...
-- MISC
theme.wallpaper_cmd         = { "awsetbg " os.getenv("HOME") .. "/.config/awesome" .. "/themes/sky/sky-background.png" }
