...
theme.wallpaper_cmd = { "awsetbg " .. os.getenv("HOME") .. "/.config/awesome/themes/default/background.png" }
...
theme.widget_cpu    = os.getenv("HOME") .. "/.config/awesome/themes/default/icons/cpu.png"
theme.widget_bat    = os.getenv("HOME") .. "/.config/awesome/themes/default/icons/bat.png"
theme.widget_mem    = os.getenv("HOME") .. "/.config/awesome/themes/default/icons/mem.png"
theme.widget_fs     = os.getenv("HOME") .. "/.config/awesome/themes/default/icons/disk.png"
theme.widget_net    = os.getenv("HOME") .. "/.config/awesome/themes/default/icons/down.png"
theme.widget_netup  = os.getenv("HOME") .. "/.config/awesome/themes/default/icons/up.png"
theme.widget_mail   = os.getenv("HOME") .. "/.config/awesome/themes/default/icons/mail.png"
theme.widget_vol    = os.getenv("HOME") .. "/.config/awesome/themes/default/icons/vol.png"
